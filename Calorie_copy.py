...
class Calculator:
    ...
    def on_add_food(self):
        ...
        self.total_macros[0] += float(calories_value)
        self.total_macros[1] += float(protein_value)
        self.total_macros[2] += float(carbs_value)
        self.total_macros[3] += float(fats_value)
    ...
    def calculate(self):
        ...
        recipe_button2 = ttk.Button(results, text="Create Recipe", command=self.give_me_recipe)
        recipe_button2.grid(row=11, column=0, padx=10, pady=5)    
    def ask_AI(self):
        ...
        headers = {
            ...
            "X-RapidAPI-Key": "29891d7d8cmsh4ac339e0c077a91p10cb8cjsnf33e1dc5e3e1",
